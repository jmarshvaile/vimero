import { POS, BG_COLOR, FG_COLOR, GLYPH, SIZE, GLYPH_SIZE, GLYPH_FAMILY, HIDDEN } from '../storage/components.js';
...
export class RenderSystem {
    constructor(engine, canvas) {
        ...
        this.view = engine.view([POS, BG_COLOR, FG_COLOR, GLYPH, SIZE, GLYPH_SIZE, GLYPH_FAMILY, HIDDEN]);
    }
